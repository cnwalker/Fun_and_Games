...
class UserProfileManager(BaseUserManager):
    def create_user(self, email, chapter, password=None):
        """
        Creates and saves a User with the given email, chapter,
        and password.
        """
        if not email:
    ...
    def create_superuser(self, email, chapter, password):
        """
        Creates and saves a superuser with the given email, chapter,
        and password.
        """
